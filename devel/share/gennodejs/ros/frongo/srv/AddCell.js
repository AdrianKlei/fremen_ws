...
class AddCellRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type AddCellRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type AddCellRequest
    let len;
    let data = new AddCellRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new AddCellRequest(null);
...
class AddCellResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type AddCellResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type AddCellResponse
    let len;
    let data = new AddCellResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new AddCellResponse(null);
...
module.exports = {
  ...
  Response: AddCellResponse,
  md5sum() { return '9703095a7d44bb2a973590113ee73ad2'; },
  datatype() { return 'frongo/AddCell'; }
};
