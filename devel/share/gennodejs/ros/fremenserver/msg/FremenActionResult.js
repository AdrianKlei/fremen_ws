...
let FremenResult = require('./FremenResult.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class FremenActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FremenResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += FremenResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FremenActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = FremenResult.Resolve(msg.result)
    }
    else {
      resolved.result = new FremenResult()
    }
...
module.exports = FremenActionResult;
